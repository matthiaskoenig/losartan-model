...
FQh = 0.215  # [-] hepatic fractional tissue blood flow  
...
GU__Ka_dis_los = 2.0  # [1/hr] rate dissolution losartan  
GU__LOSABS_k = 0.0361772268991116  # [1/min] rate of losartan absorption  
GU__METEXC_k = 2.69641608199351e-05  # [1/min] rate of feces excretion  
...
GU__f_LOSEFL_k = 1.02003554075262  # [-] fractional rate losartan efflux (PG)  
GU__f_OATP2B1 = 1.0  # [-] absorption activity  
GU__f_abcb1 = 1.0  # [-] PG activity  
HCT = 0.51  # [-] hematocrit  
HR = 70.0  # [1/min] heart rate  
KI__E3174EX_k = 0.0289271732633318  # [1/min] rate urinary excretion E3174  
KI__L158EX_k = 0.28890834506773  # [1/min] rate urinary excretion L158  
KI__LOSEX_k = 0.0773896174258953  # [1/min] rate urinary excretion losartan  
...
LI__E3174L158_k = 0.00113400909936956  # [1/min] rate losartan → L158  
LI__L158EX_k = 1.0  # [1/min] rate L158 export  
LI__LOS2E3174_Km_los = 0.0011  # [mmol/l] Km losartan → E3174  
LI__LOS2E3174_Vmax = 0.00072514631731673  # [mmol/min/l] Vmax losartan → E3174  
LI__LOSIM_k = 1.0  # [1/min] rate losartan import  
LI__MBIEX_k = 0.066315021777011  # [1/min] rate biliary export  
...
Mr_e3174 = 436.894  # [g/mol] Molecular weight e3174  
Mr_l158 = 436.894  # [g/mol] Molecular weight l158  
Mr_los = 422.911  # [g/mol] Molecular weight los  
...
ti_e3174 = 10.0  # [s] injection time e3174  
ti_los = 10.0  # [s] injection time los  
```
...
GU__los_stomach = 0.0  # [mmol] losartan (stomach) in Vstomach  
...
ald = <libsbml.ASTNode; proxy of <Swig Object of type 'ASTNode *' at 0x7860e9d76b50> >  # [mmol/l] aldosterone in Vplasma  
ang1 = <libsbml.ASTNode; proxy of <Swig Object of type 'ASTNode *' at 0x7860e9d76c40> >  # [mmol/l] angiotensin I in Vplasma  
ang2 = <libsbml.ASTNode; proxy of <Swig Object of type 'ASTNode *' at 0x7860e9d76af0> >  # [mmol/l] angiotensin II in Vplasma  
anggen = <libsbml.ASTNode; proxy of <Swig Object of type 'ASTNode *' at 0x7860e9d75e00> >  # [mmol/l] angiotensinogen in Vplasma  
cum_dose_e3174 = 0.0  # [mg] Cumulative dose due to infusion e3174  
cum_dose_los = 0.0  # [mg] Cumulative dose due to infusion los  
ren = <libsbml.ASTNode; proxy of <Swig Object of type 'ASTNode *' at 0x7860e9d74a20> >  # [mmol/l] renin in Vplasma  
```
...
CO = f_cardiac_function * BW * COBW  # [ml/s] cardiac output  
...
GU__dissolution_los = (GU__Ka_dis_los / 60) * PODOSE_los / Mr_los  # [mmol/min] dissolution losartan  
...
QC = (CO / 1000) * 60  # [l/min] cardiac output  
...
d PODOSE_los/dt = -GU__dissolution_los * Mr_los  # [mg/min] oral dose los [mg]  
