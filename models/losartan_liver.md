...
## Parameters `p`
```
E3174EX_Km_e3174 = 0.01  # [mmol/l] Km E3174 export  
E3174EX_Vmax = 1.0  # [mmol/min/l] Vmax E3174 export  
L158EX_Km_l158 = 0.01  # [mmol/l] Km L158 export  
L158EX_Vmax = 1.0  # [mmol/min/l] Vmax L158 export  
LOS2E3174_Km_los = 0.0011  # [mmol/l] Km losartan conversion  
LOS2E3174_Vmax = 0.01  # [mmol/min/l] Vmax losartan conversion  
LOS2L158_Km_los = 0.1  # [mmol/l] Km losartan conversion  
LOS2L158_Vmax = 0.02  # [mmol/min/l] Vmax losartan conversion  
LOSIM_Km_los = 0.1  # [mmol/l] Km losartan import  
LOSIM_Vmax = 0.01  # [mmol/min/l] Vmax losartan import  
MBIEX_k = 0.0001  # [1/min] rate for export in bile  
...
E3174EX = (E3174EX_Vmax / E3174EX_Km_e3174) * Vli * (e3174 - e3174_ext) / (1 + e3174_ext / E3174EX_Km_e3174 + e3174 / E3174EX_Km_e3174)  # [mmol/min] E3174 export (E3174EX)  
L158BIEX = MBIEX_k * Vli * l158  # [mmol/min] L158 bile export  
L158EX = (L158EX_Vmax / L158EX_Km_l158) * Vli * (l158 - l158_ext) / (1 + l158_ext / L158EX_Km_l158 + l158 / L158EX_Km_l158)  # [mmol/min] L158 export (L158EX)  
LOS2E3174 = f_cyp2c9 * LOS2E3174_Vmax * Vli * los / (los + LOS2E3174_Km_los)  # [mmol/min] E3174 formation (CYP2C9/3A4)  
LOS2L158 = LOS2L158_Vmax * Vli * los / (los + LOS2L158_Km_los)  # [mmol/min] L158 formation (UGT)  
LOSBIEX = MBIEX_k * Vli * los  # [mmol/min] Losartan bile export  
LOSIM = (LOSIM_Vmax / LOSIM_Km_los) * Vli * (los_ext - los) / (1 + los_ext / LOSIM_Km_los + los / LOSIM_Km_los)  # [mmol/min] losartan import (LOSIM)  
...
# odes
d e3174/dt = LOS2E3174 / Vli - E3174EX / Vli - E3174BIEX / Vli  # [mmol/l/min] E3174 (liver)  
...
d l158/dt = LOS2L158 / Vli - L158EX / Vli - L158BIEX / Vli  # [mmol/l/min] L158 (liver)  
...
d los/dt = LOSIM / Vli - LOS2E3174 / Vli - LOS2L158 / Vli - LOSBIEX / Vli  # [mmol/l/min] losartan (liver)  
